...
import { readyToBeginSection } from "@/utils/constant";
import Image from "next/image";

export default function ReadyToBegin() {
  return (
    <section className="section-container mx-auto mt-44">
      <div className="relative section-container p-0 justify-center mb-28 overflow-visible">
        <div className="relative grid grid-cols-1 lg:grid-cols-2 min-h-150 lg:min-h-146 gap-0">
          {/* Left Content */}
          ...
          <div className="relative lg:absolute lg:right-0 lg:top-4 lg:bottom-0 lg:w-1/2 h-full overflow-visible">
            <div className="relative w-full h-146">
              <Image
