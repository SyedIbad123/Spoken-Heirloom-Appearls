...
export default function SubscriptionView() {
  return (
    <div className="relative group overflow-visible mb-0">
      <div className="relative py-20 md:py-7 px-10 overflow-visible transition-transform duration-900 ease-in-out group-hover:translate-y-5">
        {/* Background image */}
